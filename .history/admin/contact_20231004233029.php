      ...
      <div class="content">
        <div class="row mt-5 pt-5">
          <div class="col d-flex flex-column">
            ...
            <a href="https://github.com/AHSANS354" target="_blank" class="d-flex align-items-center gap-3 text-dark text-decoration-none"><i class="bi bi-github text-light"></i><?= $git ?></a>
          </div>
        </div>
      </div>
    </div>
